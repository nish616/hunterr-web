...
const SHOTS: {
  ...
  },
  {
    ...
    alt: "Companies tracked, 86 companies across three ATS platforms",
    tag: "Companies",
    caption: "86 companies tracked",
    ...
    <main className="flex-1">
      ...
      <section className="container mx-auto px-6 pt-24 pb-16 md:pt-32 md:pb-20 max-w-3xl text-center">
        ...
        <p className="text-lg md:text-2xl text-muted-foreground mb-10 leading-relaxed">
          An AI job-discovery agent. Scans 86 company job boards, ranks roles
